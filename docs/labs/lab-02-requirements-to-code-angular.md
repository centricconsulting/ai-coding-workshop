...
> **💡 Also available**: [.NET version](lab-02-requirements-to-code.md) · [Java/Spring Boot version](lab-02-requirements-to-code-java.md) · [Kotlin version](lab-02-requirements-to-code-kotlin.md) · [Swift version](lab-02-requirements-to-code-swift.md)
