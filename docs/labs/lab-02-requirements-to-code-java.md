...
> **💡 Also available**: [.NET version](lab-02-requirements-to-code.md) using C# and ASP.NET Core · [Kotlin version](lab-02-requirements-to-code-kotlin.md) · [Swift version](lab-02-requirements-to-code-swift.md)
