...
> **💡 Also available**: [shared .NET version](lab-02-requirements-to-code.md) · [Java/Spring Boot version](lab-02-requirements-to-code-java.md) · [Angular version](lab-02-requirements-to-code-angular.md) · [Kotlin version](lab-02-requirements-to-code-kotlin.md) · [Swift version](lab-02-requirements-to-code-swift.md)
